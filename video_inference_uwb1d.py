...
Example
-------
CUDA_VISIBLE_DEVICES=1 python video_inference.py --input data/log_flux_vid26.pt --output_dir data/outputs/vid26_005 --target_ppp 0.05 --fps 100000 --rife_exp 4 --linear_factor 4
"""
...
# =============================================================================
MODEL_CHECKPOINT      = "./models/1024_unnormalized_linear_v2/model_best.pt"
...
def main() -> None:
    ...
    ap.add_argument("--pp_solver_iters",  type=int,   default=50)
    ap.add_argument("--pp_lr_scale",      type=float, default=0.75)
    ap.add_argument("--x_param",          type=str,   default="log",
                    choices=["log", "log1p"])

    # Interpolation / SPAD
    ap.add_argument("--rife_dir",        type=str, default="/u/scratch1/tan583/projects/phantom_simulation/ECCV2022-RIFE",
                    help="Path to the RIFE repo (contains `model/` and `train_log/`).")
    ap.add_argument("--rife_model_dir",  type=str, default="/u/scratch1/tan583/projects/phantom_simulation/ECCV2022-RIFE/train_log")
    ...
    ap.add_argument("--dark_count",      type=float, default=0)
